...
(
    ...
    common_card_id varchar (32) NOT NULL,
...
(
    company_card_id  varchar (32) NOT NULL,
    fines_id  varchar (32) NOT NULL,
...
(
    ...
    card_states_id varchar(32) NOT NULL,
...
(
    session_id varchar(32) NOT NULL,
    players_id varchar(32) NOT NULL,
